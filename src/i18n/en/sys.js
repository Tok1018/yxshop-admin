export default {
  ...
  layout: {
    ...
    mixed: 'Mixed',
    sidebar: {
      brandName: 'Smart Retail',
      brandSubtitle: 'Enterprise Hub',
      navGroup: 'Navigation',
      settings: 'Settings',
      support: 'Support',
      menuLoadFailed: 'Menu load failed',
      badgeOverflow: '99+',
      collapseTooltip: 'Collapse menu',
  ...
  login: {
    slogan: 'Mini Program Mall Management System',
    title: 'Login System',
    username: 'Username',
    ...
    puzzleTitle: 'Drag slider to verify',
    puzzleDragHint: 'Drag the slider to the right',
    puzzleSuccess: 'Verified',
    puzzleFail: 'Verification failed, please try again',
    puzzleLoadFailed: 'Failed to load captcha, please refresh',
    puzzleRetry: 'Retry',
    loginBtn: 'Login in',
    logging: 'Logging in...',
